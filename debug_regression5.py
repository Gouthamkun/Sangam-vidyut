...
# Create CognitiveConfig with the policy directly
cognitive = CognitiveConfig(
    policy=BehaviorPolicyConfig(name="cognitive_accessible_candidate_v1")
)
print(f"Cognitive config: lower={cognitive.lower_threshold}, upper={cognitive.upper_threshold}")

config = ExperimentConfig(cognitive=cognitive)
