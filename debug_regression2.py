...
# Test with DEFAULT cognitive thresholds (0.3, 0.7) instead of overridden (0.5, 0.5)
...
# DO NOT override cognitive thresholds - use defaults (0.3, 0.7)

print("=" * 80)
print("CONFIGURATION (DEFAULT THRESHOLDS: lower=0.3, upper=0.7)")
print("=" * 80)
...
print(f"cognitive_mode: deterministic (but with default thresholds)")
...
# Check thresholds
print(f"Lower threshold: {config.cognitive.lower_threshold}")
